        ...
        <div className="dashboard-overview-container">
          ...
          <div className="lower-overview-card-container">
            ...
            <div className="lower-overview-card">
              ...
              <div className="lower-card-text-container">
                <h3>Total Profit</h3>
                <p style={{ color: userData && userData.trades ? (userData.trades.reduce((acc, trade) => acc + (trade.tradeType === 'profit' ? Number(trade.amount) : -Number(trade.amount)), 0) >= 0 ? '#4caf50' : '#f44336') : 'white' }}>
                  ${userData && userData.trades
                    ? formatCurrency(userData.trades.reduce((acc, trade) => acc + (trade.tradeType === 'profit' ? Number(trade.amount) : -Number(trade.amount)), 0))
                    : '0'
                  }
                </p>
              </div>
                ...
                <tbody>
                  {
                    dailyTrades.map(refer =>
                      <tr className='tr'>
                        <td>{refer.pair}</td>
                        <td>$ {formatCurrency(refer.amount)} USD</td>
