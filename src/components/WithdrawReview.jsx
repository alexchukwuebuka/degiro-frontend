                ...
                <div className="withdrawal-review-container">
                    <div className="left-withdrawal-review-card">
                        <div className="review-left-card-tab">
                            <p>Current Balance: <b>{formatCurrency(funded)} USD</b></p>
                        </div>
                        <div className="review-left-card-tab">
                            <p>Request Balance: <b>{amount ? formatCurrency(amount) : ''} USD</b></p>
                        </div>
                        <div className="review-left-card-tab">
                        ...
                        <div className="review-left-card-tab">
                            <p>You Will Get: <b>{amount ? formatCurrency(amount) : ''} USD</b></p>
                        </div>
                        <div className="review-left-card-tab">
                            <p>Balance Will be: <b>{formatCurrency(funded - amount)} USD</b></p>
                        </div>
